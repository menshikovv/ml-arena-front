...
export default function Profile() {
  ...
  const overallQuery = useQuery({ queryKey: ["profile-rating", "overall"], queryFn: () => api.rating.get({ tab: "overall" }), enabled: isOwner });
  const competitionsQuery = useQuery({ queryKey: ["profile-rating", "competitions"], queryFn: () => api.rating.get({ tab: "competitions" }), enabled: isOwner });
  const duelsQuery = useQuery({ queryKey: ["profile-rating", "duels"], queryFn: () => api.rating.get({ tab: "duels" }), enabled: isOwner });
