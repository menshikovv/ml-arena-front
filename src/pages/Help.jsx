...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    body: "Нажмите «Регистрация» и создайте аккаунт с помощью доступного способа входа. После регистрации рекомендуем заполнить профиль. Основные сведения пользователь указывает самостоятельно, а подтверждённые результаты и статистика ML-паспорта формируются отдельно на основании активности.",
  ...
  },
  {
    ...
    action: { label: "Перейти к сотрудничеству", to: "/contacts/cooperation" },
  },
];
...
const CONTACTS = [
  ...
  { title: "Сотрудничество", text: "Корпоративные соревнования, поиск специалистов и совместные ML-проекты.", action: "Перейти к сотрудничеству", to: "/contacts/cooperation", icon: BriefcaseBusiness, tone: "bg-[hsl(var(--chart-4)/0.14)] text-[hsl(var(--chart-4))]" },
];
