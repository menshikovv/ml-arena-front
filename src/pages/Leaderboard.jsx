...
export default function Leaderboard() {
  ...
  return (
    <div className="mx-auto w-full max-w-[1380px] px-4 py-6 md:px-6 lg:px-8 lg:py-10">
      ...
      {!seasonsQuery.isLoading && !season ? <div className="mt-8 border border-dashed border-border bg-card px-6 py-16 text-center"><CalendarClock className="mx-auto text-muted-foreground" size={28} /><h2 className="mt-4 font-heading text-2xl font-extrabold">Сезон рейтинга ещё не создан</h2><p className="mx-auto mt-2 max-w-xl text-sm leading-6 text-muted-foreground">Стартовый рейтинг профиля не является местом в сезонной таблице. Администратору нужно создать и активировать сезон.</p></div> : <section className="mt-8">
