...
export const api = {
  ...
  organizations: {
    ...
    metrics: (id) => apiData(`/api/v1/organizations/${id}/metrics`),
    metricVersions: (organizationId, metricId) => apiData(`/api/v1/organizations/${organizationId}/metrics/${metricId}/versions`),
    createMetric: (id, body) => apiData(`/api/v1/organizations/${id}/metrics`, { method: "POST", body: json(body) }),
    createMetricVersion: (organizationId, metricId, body) => apiData(`/api/v1/organizations/${organizationId}/metrics/${metricId}/versions`, { method: "POST", body: json(body) }),
    submitMetricVersion: (organizationId, metricId, versionId) => apiData(`/api/v1/organizations/${organizationId}/metrics/${metricId}/versions/${versionId}/submit-for-moderation`, { method: "POST" }),
  },
  duels: {
  ...
  admin: {
    ...
    pendingMetricReviews: () => apiData("/api/v1/admin/metrics/pending-review"),
    testMetricVersion: (id) => apiData(`/api/v1/admin/metric-versions/${id}/test`, { method: "POST" }),
    metricValidationRuns: (id) => apiData(`/api/v1/admin/metric-versions/${id}/validation-runs`),
    metricVersionSource: (id) => apiData(`/api/v1/admin/metric-versions/${id}/source`),
    metricVersionAction: (id, action, comment) => apiData(`/api/v1/admin/metric-versions/${id}/${action}`, { method: "POST", body: json({ comment: comment || null }) }),
