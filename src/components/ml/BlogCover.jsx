  ...
  if (visual?.imageUrl) {
    return (
      <div className={`relative overflow-hidden bg-secondary ${className}`}>
        {!compact && <img src={visual.imageUrl} alt="" aria-hidden="true" decoding="async" className="absolute -inset-8 h-[calc(100%+4rem)] w-[calc(100%+4rem)] scale-110 object-cover opacity-40 blur-3xl saturate-75" />}
        <img
          src={visual.imageUrl}
          alt={visual.alt || ""}
